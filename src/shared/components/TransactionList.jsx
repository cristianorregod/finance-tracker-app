...
export const TransactionListTable = ({ transactions, tableHeaders }) => {
  ...
  return (
    <Card className="h-full w-full lg:col-span-3">
        ...
        <div className="mb-4 flex flex-col justify-between gap-8 md:flex-row md:items-center">
          ...
          <div className="hidden lg:flex w-full shrink-0 gap-2 md:w-max">
            ...
            <Button
              ...
              size="sm"
              onClick={() => dispatch(setDefaultDialogOpen(true))}
            >
          ...
          <thead>
            <tr>
              {tableHeaders.map((head) => (
                <th
                  key={head.label}
                  className={`border-y border-blue-gray-100 bg-blue-gray-50/50 p-4 ${head.width}`}
                >
                  <Typography
                    variant="small"
                    color="blue-gray"
                  ...
                  <tr key={title}>
                    ...
                    <td className={"w-fit"}>
                      <Typography
                        variant="small"
                        color="blue-gray"
                        className="font-normal capitalize flex gap-x-1 "
                      >
                        ...
                        <div className="flex flex-col">
                          ...
                          >
                            <Chip
                              value={type}
                              size="sm"
                              className={transactionsColors[type]}
                            />
                          </Typography>
                        </div>
                      </div>
